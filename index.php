	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if($text == 'วิธีใช้'){
				$messages = [
				'type' => 'text',
				'text' => "พื้นฐาน~[วิธีใช้งาน] ธ ปท Fire✿bird❀bot✍\nจะช่วย อธิบายคำสั่งSiriและข้อแนะนำไม่ยุ่งยาก \nธ ปท★ใช้ความสดวกได้ไม่มีกำหนดบอทหมดอายุ\n<ความต้องการ>____<พิมพ์>\n※เปิดให้สิริตอบคำสั่ง(เปิดบอท)\n※ปิดให้siriไม่ชอบคำสั่ง(ปิดบอท)\n※เชคดูแอดมินห้อง(เชคแอดมิน)\n※เชคดูแอดสำรอง(เชคแอดสำรอง)\n※ดูตั้งค่าในกลุ่มทั้งหมด(เชคตั้งค่า)\n※ดูเวอร์ชั่นรุ่นบอทSiri(เชครุ่นบอท)\n※ตั้งค่าเริ่มตั่นการอ่าน(ตั้งเวลา)\n※ตรวจดูคนอ่าน(ใครแอบ)\n※หากบอทไม่ครบชุดเรียกกลับ(เรียกบอทกลับ)\n※รับคำสั่งสิริจาก ธ ปท(ขอคำสั่งสิริ)\n※กรณี,แอดมินลบบัญชี(อัปเดตแอดมิน)\n※รับคำสั่งโดยตรงจากSiri(ช่วยเหลือ)\n_____________•••••••_________"
			];}
