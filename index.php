...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		elseif ($event['type'] == 'message' && $event['message']['type'] == 'sticker') {
			...
			$stickerarray = array('ว๊าย ขี้อวด', '', 'รู้แล้วจ๊ะ ว่ามีสติ๊กเกอร์ใช้', '', 'เพิ่งเคยใช้สติ๊กเกอร์สินะ', '', 'ไปไถสติ๊กเกอร์นี้มาจากไหน ขอตำแหน่งด่วน !!!', '', 'ลบทิ้งไปเถอะ สติ๊กเกอร์กาก ๆ แบบนี้ เก็บไว้ก็เปลืองความจำเครื่อง', '', 'กลัวใช้ไม่คุ้นหรือไง ส่งอยู่ได้ สติ๊กเกอร์', '', 'เกลียดติ๊กนี้ ขอร้อง อย่าส่งอีกนะ สงสารผมเถอะ', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
