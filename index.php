...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			$result_array = array('ไม่มีสมองพิมพ์เองหรือไง ขี้ก๊อป อายคนอื่นเขาบ้างเถอะ ','ว๊าย ขี้ก็อป','บ้านอยู่ต่างประเทศเปล่าเนี่ย จีนแดงอ่ะนะ','ไม่มีสมอง ก็อปคนอื่นไปเรื่อย','อุ้ย ควาย ก๊อป','เกรียน จริง ๆ แค่นี้ก็ต้องก็อป','กินหญ้าเป็นอาหารเช้ารึเปล่า เรื่องแค่นี้ถึงไม่มีสมองคิดเอง');
			$output_result_array = $result_array[array_rand($result_array,1)];
			
			$result_array   = array_search($text,$result_array); 
			...
			$reaction_array = array('ก็บ้า เพราะคุยกับคุณนั่นแหละ', 'ก็บ้าเหมือนกันนั่นแหละ คนอะไรคุยกับบอท', 'ศรีธัญญาไปทางไหน ไปด้วยกันไหม', 'ฉีดยาแล้ว ไม่บ้าหรอก ว่าแต่คุณฉีดหรือยัง ?', 'กรุณาวางถุงกาวลงเเละตั้งสติ','คนพิมพ์ก็เช่นกัน','คนพิมพ์ก็เช่นกัน','คนพิมพ์ก็เช่นกัน','คนพิมพ์ก็เช่นกัน','คนอ่านก็เช่นกัน','คนพิมพ์ก็เช่นกัน','ผมเตือนคุณแล้วนะ อย่าให้ผมต้องเรียกคุณว่า ไอ้กาก เลยครับ นะครับ ไอ้กาก หยุดนะครับ', 'หยุดเถอะ คนอื่นเค้าจะรำคาญเอานะ', 'อย่าว่าคนอื่นแบบนั้นสิ พ่อแม่ที่บ้าน ไม่เคร่งเรื่องมารยาทสินะ ถึงได้พิมพ์แบบนี้','ใจเย็น ๆ ค่อย ๆ พิมพ์', 'ใจเย็ด ๆ  ค่อย ๆ พิมพ์ เอ้ย ใจเย็น ๆ ค่อย ๆ พิมพ์', 'กรุณาวางแป้นพิมพ์ แล้วตั้งสติ', 'กรุณาวางถุงกาวลงเเละตั้งสติ', 'กากทั้งวันทั้งคืน เสพติดความกากสินะ','อย่าด่าว่า กาก เดี๋ยวปากจะร้าวเอาได้นะ', 'ถามใจเธอดู เบื่อไหม กับคำว่า กาก','คนพิมพ์นี่ สงสัยบ้านไม่มีกระจกเนอะ ว่าง ๆ ตักน้ำใส่กะโหลก ชะโงกดูเงาตัวเอง บ้างนะ กาก ติดกลางหน้าผากเลย','กากทุกคนนั้นแหละ ไม่ต้องแย่งกัน แบ่ง ๆ กันไป','กากมาก ก. ไก่ ล้านตัว','กาก จริง ๆ เนอะ','เห็นด้วย 100 % ครับ เจ้านาย','คนพิมพ์นั่นแหละ กาก','ปุ่มไลค์ อยู่ตรงไหน ไม่ได้จะกดไลน์นะ แต่จะกระทืบไลค์เลย','กดไลค์ให้ 1 ที ถูกใจเล็กน้อย','ว่าแต่ กาก คืออัลลัย บอทไม่เข้าใจ','เก็บความกากไว้ใช้เองเถอะ','อย่ายัดเยียดความกากให้คนอื่นเลย','ว่าแต่คนอื่น อิเหนาเป็นเอง เคยได้ยินม่ะ','คำนี้ ผมขอเถอะ อย่าพิมพ์อีกนะ','ต้องเลวขนาดไหน ถึงกล้าพิมพ์แบบนี้','ใช่ กากมาก คนที่พิมพ์อ่ะนะ','ใช่ กากมาก','ช่าย กากมาก','เรียนมาน้อยสินะ เลยพิมพ์ได้แค่คำว่า กาก', 'ปมด้อยสินะ ถึงว่าคนอื่นกาก', 'ว่าคนอื่นกาก ก็กากเหมือนกันแหละว้า', 'กาก กาก กาก กาก กาก กาก กาก กาก กาก พอใจม่ะ', 'อย่าหาว่าสอนเลยนะ คำว่า กาก เค้าไว้ใช้เรียกคุณนั่นแหละ', 'ไม่ได้ไปกากบนหัวคุณสักหน่อย', 'พิมพ์คำอื่นไม่เป็นหรือไง', 'กากแล้วไง ไปยุ่งกับเค้าทำไม', 'ใครกันแน่ที่กาก', 'มั่นใจว่ากาก', 'กากแล้วทำไม', 'พ่อแม่ไม่รักสินะ ถึงว่าคนอื่น', 'กาก แล้วไง', 'มีปัญหาป่ะ', 'กาก ก๊าก กาก', 'กากจริง ๆ', 'เดินไปส่องกระจกสิ จะเจอกากกว่า', 'กอ อา กอ กาก', 'ขอบคุณ','อย่าส่งให้เห็นอีกนะ', 'อิจฉาคนมีสติ๊กเกอร์ใช้จัง', 'มีเงินอย่างเดียวซื้อลายนี้ไม่ด้นะเนี่ย ต้อง... ด้วย', 'คิดยังไงถึงซื้อลายนี้', 'ตอนโหลดลายนี้ ใช้อะไรคิด', 'ลายกาก ๆ แบบนี้ กล้าใช้เนอะ', 'สติ๊กเกอร์กาก ๆ', 'อย่าให้เห็นว่าส่งอีกนะ', 'พิมพ์บ้างก็ดีนะ ', 'ขอลายอื่นได้ม่ะ ลายนี้เบื่อแล้ว', 'คนบ้าอะไร ส่งแต่สติ๊กเกอร์', 'ว๊าย ขี้อวด', 'รู้แล้วจ๊ะ ว่ามีสติ๊กเกอร์ใช้', 'เพิ่งเคยใช้สติ๊กเกอร์สินะ', 'ไปไถสติ๊กเกอร์นี้มาจากไหน ขอพิกัดด่วน !!!', 'ลบทิ้งไปเถอะ สติ๊กเกอร์กาก ๆ แบบนี้ เก็บไว้ก็เปลืองความจำเครื่อง', 'กลัวใช้ไม่คุ้มหรือไง ส่งอยู่ได้ สติ๊กเกอร์', 'เกลียดสติ๊กเกอร์ลายนี้ ขอร้อง อย่าส่งอีกนะ สงสารผมเถอะ', 'สติ๊กเกอร์ฟรีหรือเปล่าเนี่ย ถึงส่งได้ส่งดี', 'จะอวดไปถึงไหน รู้แล้วจ้า ว่ามีสติ๊กเกอร์ใช้', 'ส่งมาบ่อย ๆ ซื้อให้มั่งก็ดีนะ', 'อย่าส่งให้เห็นอีกนะ ลบทิ้งไปเลยก็ดี สติ๊กเกอร์ลายกาก ๆ แบบนี้', 'จะอวดว่ามีสติ๊กเกอร์ใช้สินะ', 'ส่งบ่อย ๆ ไม่ดีนะ เดี๋ยวพี่ しりちゃん v10 เค้าโมโหเอานะ', 'ซื้อใหม่บ้างเถอะ สติ๊กเกอร์ลายนี้ คิดว่าใช้คุ้มแล้วนะ เห็นจนเบื่อแล้ว', 'พิมพ์บ้างเถอะ อย่าส่งแต่สติ๊กเกอร์เลย จะได้ไม่เป็นภาระของสังคมไลน์', 'โทรศัพท์กากรึ ไม่มีแป้นพิมพ์ ถึงกดส่งแต่สติ๊กเกอร์', 'เรียนมาน้อยสินะ ถึงพิมพ์ไม่เป็น ส่งแต่สติ๊กเกอร์อยู่ได้','มีเงินอย่างเดียวซื้อลายนี้ไม่ได้นะเนี่ย ต้องโง่ด้วยนะเนี่ย');

			$result_reaction_array   = array_search($text,$reaction_array ); 
 
			if($result_reaction_array!=FALSE){
			$messages = [
				'type' => 'text',
				'text' => $output_result_array
			];}
			...
			$arraybot = array('', '', '', '', '', 'เรียกบ่อย ๆ มีปัญหาอะไร', 'ไปนอนไป เบื่อขี้หน้า', 'ว่างมากสินะ', 'เบื่อคน', 'ทำไม มีอะไร เรียกจัง', 'ชื่อเล่นแม่คุณรึไง', 'ว่างหรา', 'มีอะไร คนกาก', 'จ๋าจ๊ะ', 'ว่าไงจ๊ะ', 'คิดถึงล่ะซี้', 'เรียกทำไมจ๊ะ', 'ด่าได้ แต่อย่าแรง', 'ชื่อเหมือนพ่อคุณหรอ', 'บอทไงจ๊ะ จะใครล่ะ', 'ครับผม จะรีบไปไหน จะรีบไปไหน พักเดี๋ยวหนึ่งซิครับ', '', '', '', '', '', '', '', '', '', '', '', '');
			...
			$arrayyyy = array('','','','','','','','','','','','','คนพิมพ์ก็เช่นกัน','คนพิมพ์ก็เช่นกัน','คนพิมพ์ก็เช่นกัน','คนพิมพ์ก็เช่นกัน','คนอ่านก็เช่นกัน','คนพิมพ์ก็เช่นกัน','ผมเตือนคุณแล้วนะ อย่าให้ผมต้องเรียกคุณว่า ไอ้กาก เลยครับ นะครับ ไอ้กาก หยุดนะครับ', 'หยุดเถอะ คนอื่นเค้าจะรำคาญเอานะ', 'อย่าว่าคนอื่นแบบนั้นสิ พ่อแม่ที่บ้าน ไม่เคร่งเรื่องมารยาทสินะ ถึงได้พิมพ์แบบนี้','ใจเย็น ๆ ค่อย ๆ พิมพ์', 'ใจเย็ด ๆ  ค่อย ๆ พิมพ์ เอ้ย ใจเย็น ๆ ค่อย ๆ พิมพ์', 'กรุณาวางแป้นพิมพ์ แล้วตั้งสติ', 'กรุณาวางถุงกาวลงเเละตั้งสติ', 'กากทั้งวันทั้งคืน เสพติดความกากสินะ','อย่าด่าว่า กาก เดี๋ยวปากจะร้าวเอาได้นะ', 'ถามใจเธอดู เบื่อไหม กับคำว่า กาก','คนพิมพ์นี่ สงสัยบ้านไม่มีกระจกเนอะ ว่าง ๆ ตักน้ำใส่กะโหลก ชะโงกดูเงาตัวเอง บ้างนะ กาก ติดกลางหน้าผากเลย','กากทุกคนนั้นแหละ ไม่ต้องแย่งกัน แบ่ง ๆ กันไป','กากมาก ก. ไก่ ล้านตัว','กาก จริง ๆ เนอะ','เห็นด้วย 100 % ครับ เจ้านาย','คนพิมพ์นั่นแหละ กาก','ปุ่มไลค์ อยู่ตรงไหน ไม่ได้จะกดไลน์นะ แต่จะกระทืบไลค์เลย','กดไลค์ให้ 1 ที ถูกใจเล็กน้อย','ว่าแต่ กาก คืออัลลัย บอทไม่เข้าใจ','','','','','','','','','','เก็บความกากไว้ใช้เองเถอะ','อย่ายัดเยียดความกากให้คนอื่นเลย','ว่าแต่คนอื่น อิเหนาเป็นเอง เคยได้ยินม่ะ','คำนี้ ผมขอเถอะ อย่าพิมพ์อีกนะ','ต้องเลวขนาดไหน ถึงกล้าพิมพ์แบบนี้','ใช่ กากมาก คนที่พิมพ์อ่ะนะ','ใช่ กากมาก','ช่าย กากมาก','เรียนมาน้อยสินะ เลยพิมพ์ได้แค่คำว่า กาก', 'ปมด้อยสินะ ถึงว่าคนอื่นกาก', 'ว่าคนอื่นกาก ก็กากเหมือนกันแหละว้า', 'กาก กาก กาก กาก กาก กาก กาก กาก กาก พอใจม่ะ', 'อย่าหาว่าสอนเลยนะ คำว่า กาก เค้าไว้ใช้เรียกคุณนั่นแหละ', 'ไม่ได้ไปกากบนหัวคุณสักหน่อย', 'พิมพ์คำอื่นไม่เป็นหรือไง', 'กากแล้วไง ไปยุ่งกับเค้าทำไม', 'ใครกันแน่ที่กาก', 'มั่นใจว่ากาก', 'กากแล้วทำไม', 'พ่อแม่ไม่รักสินะ ถึงว่าคนอื่น', 'กาก แล้วไง', 'มีปัญหาป่ะ', 'กาก ก๊าก กาก', 'กากจริง ๆ', 'เดินไปส่องกระจกสิ จะเจอกากกว่า', 'กาก', 'กอ อา กอ กาก', 'ขอบคุณ', $text, $text, $text, $text, $text, $text);
			...
			$arrayyy = array('ฝันดีครับ', 'ฝันดีค่ะ', 'นอนหลับฝันดีนะ', 'Sweet dreams.', 'Good Night', 'GN', 'ฝันดีผีกัดตูด', 'ราตรีสวัสดิ์', 'นอนหลับฝันดี ฝันถึงเราด้วยนะ', $text);
			...
			$arrayy = array('สวัสดีครับ', 'สวัสดีค่ะ', 'ดีครับ', 'ดีค่ะ', 'ดีคับ', 'หวัดดีคับ', 'หวัดดีครับ', 'หวัดดีค่ะ', $text);
			...
			$arraymorning = array('วัวไม่ขยับครับ', 'วัวไม่ขยับค่ะ', 'มอนิ่งครับ', 'มอนิ่งค่ะ', 'Good morning', $text);
			...
			$arrayba = array('ก็บ้า เพราะคุยกับคุณนั่นแหละ', 'ก็บ้าเหมือนกันนั่นแหละ คนอะไรคุยกับบอท', 'ศรีธัญญาไปทางไหน ไปด้วยกันไหม', 'ฉีดยาแล้ว ไม่บ้าหรอก ว่าแต่คุณฉีดหรือยัง ?', 'กรุณาวางถุงกาวลงเเละตั้งสติ', $text, $text, $text);
			...
			$arraygag = array('กาก เขาพิมพ์กันแบบนี้จ๊ะ ถ้าจะกาก กรุณากากอย่างมีรสนิยมนะจ๊ะ', 'กาก เขาพิมพ์กันแบบนี้จ๊ะ ถ้าจะกาก กรุุณากากอย่างมีสติด้วยนะจ๊ะ', 'กาก ไม่ใช่ กๅก', 'โปรดใช้สติขณะพิมพ์ด้วยจ๊ะ', $text);
		...
		elseif ($event['type'] == 'message' && $event['message']['type'] == 'sticker') {
			...
			$stickerarray = array('', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '', '', '','', '', '', '', '', '', '', '', '', '', '', '', '', '','อย่าส่งให้เห็นอีกนะ', '', 'อิจฉาคนมีสติ๊กเกอร์ใช้จัง', '', 'มีเงินอย่างเดียวซื้อลายนี้ไม่ได้นะเนี่ย ต้องโง่ด้วยนะเนี่ย', '', 'คิดยังไงถึงซื้อลายนี้', '', 'ตอนโหลดลายนี้ ใช้อะไรคิด', '', 'ลายกาก ๆ แบบนี้ กล้าใช้เนอะ', '', 'สติ๊กเกอร์กาก ๆ', '', 'อย่าให้เห็นว่าส่งอีกนะ', '', 'พิมพ์บ้างก็ดีนะ ', '', 'ขอลายอื่นได้ม่ะ ลายนี้เบื่อแล้ว', '', 'คนบ้าอะไร ส่งแต่สติ๊กเกอร์', '', 'ว๊าย ขี้อวด', '', 'รู้แล้วจ๊ะ ว่ามีสติ๊กเกอร์ใช้', '', 'เพิ่งเคยใช้สติ๊กเกอร์สินะ', '', 'ไปไถสติ๊กเกอร์นี้มาจากไหน ขอพิกัดด่วน !!!', '', 'ลบทิ้งไปเถอะ สติ๊กเกอร์กาก ๆ แบบนี้ เก็บไว้ก็เปลืองความจำเครื่อง', '', 'กลัวใช้ไม่คุ้มหรือไง ส่งอยู่ได้ สติ๊กเกอร์', '', 'เกลียดสติ๊กเกอร์ลายนี้ ขอร้อง อย่าส่งอีกนะ สงสารผมเถอะ', '', 'สติ๊กเกอร์ฟรีหรือเปล่าเนี่ย ถึงส่งได้ส่งดี', '', 'จะอวดไปถึงไหน รู้แล้วจ้า ว่ามีสติ๊กเกอร์ใช้', '', 'ส่งมาบ่อย ๆ ซื้อให้มั่งก็ดีนะ', '', 'อย่าส่งให้เห็นอีกนะ ลบทิ้งไปเลยก็ดี สติ๊กเกอร์ลายกาก ๆ แบบนี้', '', 'จะอวดว่ามีสติ๊กเกอร์ใช้สินะ', '', 'ส่งบ่อย ๆ ไม่ดีนะ เดี๋ยวพี่ しりちゃん v10 เค้าโมโหเอานะ', '', 'ซื้อใหม่บ้างเถอะ สติ๊กเกอร์ลายนี้ คิดว่าใช้คุ้มแล้วนะ เห็นจนเบื่อแล้ว', '', 'พิมพ์บ้างเถอะ อย่าส่งแต่สติ๊กเกอร์เลย จะได้ไม่เป็นภาระของสังคมไลน์', '', 'โทรศัพท์กากรึ ไม่มีแป้นพิมพ์ ถึงกดส่งแต่สติ๊กเกอร์', '', 'เรียนมาน้อยสินะ ถึงพิมพ์ไม่เป็น ส่งแต่สติ๊กเกอร์อยู่ได้', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
