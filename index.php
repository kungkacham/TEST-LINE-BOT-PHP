	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if(strstr($text,'กฎเทส')){
				$messages = [
				'type' => 'text',
				'text' => "กฎในการทดสอบก่อนเข้าแคลน (ปรับปรุง 02/11/59) /n/t/n 1. ไม่อยู่ในสังกัดของแคลนใด ๆ ขณะทำการทดสอบ หากทราบจะทำการแบนทันที /n/t/n 2. จะต้องมีการ์ดตัวละคร S+ LV. 30 คุมเต๋า 83 ขึ้นไป และมีจี้ที่จำเป็นสำหรับสายวิคเตอรี่และสายล้มละลาย เทียบเท่า S+ LV. 7 ขึ้นไป พร้อมความสามารถพิเศษของจี้เครื่องราง S+ ที่เหมาะสม (อาจมีการเปลี่ยนแปลงตามความเหมาะสม ขึ้นอยู่กับผู้ทำทดสอบ) ถ้าจี้ S+ LV. 7 ยังไม่ครบ 4 ชิ้นขึ้นไป จะยังไม่ส่งลงแข่งในรายการต่าง ๆ /n/t/n 3. จะทำการทดสอบด้วยแผนที่ 'ประเทศไทย' 2 ครั้ง /n โดยจะเป็นการทดสอบแบบเดี่ยว 1 ครั้ง และแบบทีม 1 ครั้ง ต้องชนะอย่างน้อย 1 ครั้ง จึงจะสามารถผ่านเข้าแคลนได้ อนุโลมได้ถ้าผู้ทำการทดสอบเห็นว่ามีศักยภาพมากพอในการเข้าร่วมกับแคลนได้ /n/t/n * การทดสอบแบบทีมให้ผู้ที่มาขอเข้าทดสอบเล่นคู่กับผู้ทำการทดสอบ แล้วไปสุ่มหาคู่แข่งในห้อง 10 M /n * การทดสอบอาจมีการเปลี่ยนแปลงตามความเหมาะสม ขึ้นอยู่กับผู้ทำการทดสอบ /n/t/n 4. หากทดสอบแล้ว 'ผ่าน' ให้ผู้มาขอเข้าทดสอบเปลี่ยนชื่อในไลน์เป็น (OMG)-ชื่อ-ตัวเลข ส่วนในเกมให้เปลี่ยนเป็น (OMG)-ตัวเลข เช่น ชื่อในไลน์เป็น (OMG)-ABC-00 ในเกมส์จะเป็น (OMG)-00 ชื่อในเกมสามารถเปลี่ยนทีหลังได้ หากไม่มีเพชรเปลี่ยน แต่ต้องเปลี่ยนภายใน 24 ชม. หลังจากทราบว่า 'ผ่าน' แล้ว  /n/t/n *ตัวเลขที่ต้องใส่ผู้ทำการทดสอบจะเป็นคนแจ้งให้ทราบ /n/t/n 5. เมื่อดึงเข้าแคลนแล้ว ให้แนะนำตัว (ชื่อ อายุ) และอ่านโน๊ตทุกโน๊ตที่ถูกโพสต์ในหน้าโน๊ตของห้องแคลน /n/t/n 6. ต้องมีเวลาว่างช่วงเวลา 17.00 - 22.30 น. ตรงต่อเวลา และเข้ามาคุยในแคลนเป็นประจำ /n/t/n 7. ปฏิบัติตามกฎของแคลนได้ทุกข้อ สามารถอ่านได้ที่โน๊ตของกลุ่ม /n/t/n *** ไม่สะดวกข้อไหนกรุณาแจ้งล่วงหน้า มิฉะนั้นหากเข้าแคลนแล้ว อาจโดนให้ออกจากแคลน โดยไม่แจ้งให้ทราบล่วงหน้า /n"
			];}
