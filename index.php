...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			$arrayba = array('ก็บ้า เพราะคุยกับคุณนั่นแหละ', 'ก็บ้าเหมือนกันนั่นแหละ คนอะไรคุยกับบอท', 'ศรีธัญญาไปทางไหน ไปด้วยกันไหม', 'ฉีดยาแล้ว ไม่บ้าหรอก ว่าแต่คุณฉีดหรือยัง ?', $text, $text, $text);
