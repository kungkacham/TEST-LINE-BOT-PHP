...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			$result_array = array('ไม่มีสมองพิมพ์เองหรือไง ขี้ก๊อป อายคนอื่นเขาบ้างเถอะ ','ว๊าย ขี้ก็อป','บ้านอยู่ต่างประเทศเปล่าเนี่ย จีนแดงอ่ะนะ','ไม่มีสมอง ก็อปคนอื่นไปเรื่อย','อุ้ย ควาย ก๊อป','กาก เกรียน จริง ๆ แค่นี้ก็ต้องก็อป','กินหญ้าเป็นอาหารเช้ารึเปล่า เรื่องแค่นี้ถึงไม่มีสมองคิดเอง');
